...
export default function AdminMarketingFlashSale() {
  return (
    <AdminLayout>
      <div className="flex flex-col gap-6">
        <div>
          <h1 className="text-2xl font-bold text-stone-800">商店的限时选购</h1>
        ...
        <Card className="p-12 flex items-center justify-center bg-white min-h-[400px]">
          <div className="text-center">
            ...
            <h2 className="text-xl font-medium text-stone-700 mb-2">商店的限时选购 模块建设中</h2>
